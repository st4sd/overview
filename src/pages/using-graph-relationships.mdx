...
def relationship_push(api: experiment.service.db.ExperimentRestAPI):
    ...
    Notes:
      ...
      packages into your private registry.
      The parameterised packages are: ::

        1. configuration-generator-ani (contains the inputGraph)
           - Get it with:
             `wget https://st4sd.github.io/overview/pvep/configuration-generator-ani.json`
        2. band-gap-dft-gamess-us (contains the outputGraph)
           - Get it with:
             `wget https://st4sd.github.io/overview/pvep/band-gap-dft-gamess-us.json`
    """

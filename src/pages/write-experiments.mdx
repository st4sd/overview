...
- A virtual environment with the `st4sd-runtime-core` python module
    ...
    python -m venv venv
    . ./venv/bin/activate
    pip pip install "st4sd-runtime-core[develop]>=2.5.1"
    ```

...
Spend up to 60 minutes familiarizing yourself with building an experiment. This page assumes you are familiar with running experiments locally using the elaunch.py command line tool. If you need a refresher take a moment to look our [docs](/direct-run) before continuing any further.

...
download the band-gap-dft-gamess-us experiment that is available on a public registry.

We can simply copy the link and run:

```commandline
stp package download https://<base-url>/registry-ui/experiment/band-gap-dft-gamess-us
```
...
```commandline
stp package import https://<registry-url>/registry-ui/experiment/band-gap-dft-gamess-us
```

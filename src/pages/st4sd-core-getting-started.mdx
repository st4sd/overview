...
```bash
#This command creates a directory that will provide input to the next command
...
Note, this experiment requires `docker` is installed on your laptop.
...
When the experiment is finished `cat nanopore-geometry-experiment.instance/properties.csv` for the measured properties of the material.

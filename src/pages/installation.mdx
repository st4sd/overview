...
For installing ST4SD on **OpenShift** see <https://github.com/st4sd/st4sd-olm>.
This gives details to setup st4sd-olm and how to use the Operator Lifecycle Manager (OLM) framework to install
ST4SD on your cluster.

For customizing ST4SD post installation see <https://github.com/st4sd/st4sd-deployment>.
This gives comprehensive details on customizing ST4SD deployments using `helm`.
